...
var hangmanGame = {
    ...
    rebuildWordView: function() {
        ...
        for (var i = 0; i < this.lettersOfTheWord.length; i++) {
            ...
            if (this.matchedLetters.indexOf(this.lettersOfTheWord[i]) !== -1) {
                wordView += this.lettersOfTheWord[
                    i// If it hasn't been guessed, display a "_" instead.
                ];
            } else {
                wordView += "&nbsp;_&nbsp;";
            }
    ...
    updateWins: function() {
        ...
        if (win) {
            ...
            document.querySelector("#bandDiv").innerHTML = "<img class='band-image' src='images/" + this.wordsToPick[this.wordInPlay].picture + "' alt='" + this.wordsToPick[this.wordInPlay].song + "'>";
